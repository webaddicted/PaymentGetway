class StrConst {
  static const String APP_NAME = 'Online Pay';
  static bool DEBUG = false;
//  {START TITLE}
  static var DUMMY_TXT =
  ...
  static var SOMETHING_WENT_WRONG =
      'Something went wrong please try again later.';
  static var INVITE_TITLE = APP_NAME + "\nRefer and Earn";
  static var REFER_DESC =
      'Invite and earn 50 point\n\nhttps://play.google.com/store/apps/details?id=com.webaddicted.movies4u';
  static var are_you_sure_exit = 'Are you sure you want to exit this app?';
  static var yes = 'Yes';
  static var no = 'No';
  ...
  static var TITLE_RAZORPAY = 'Razorpay';
  static var TITLE_HOME = APP_NAME;
  static var TITLE_PAYTM = 'Paytm';
  static var TITLE_PAYPAL_PAYMENT = 'Paypal Paytm';
}
