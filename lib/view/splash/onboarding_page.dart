...
import 'package:payment_getway/view/widget/slide_dots.dart';
...
final sliderArrayList = [
  Slider(
      ...
      sliderHeading: StringConst.sliderTitle1,
      sliderSubHeading: StringConst.sliderDesc1,
      skipBtn: 'SKIP'),
  Slider(
      sliderImageUrl: AssetsConst.slider3,
      sliderHeading: StringConst.sliderTitle2,
      sliderSubHeading: StringConst.sliderDesc2,
      skipBtn: 'SKIP'),
  Slider(
      sliderImageUrl: AssetsConst.slider2,
      sliderHeading: StringConst.sliderTitle3,
      sliderSubHeading: StringConst.sliderDesc3,
      skipBtn: ""),
];
